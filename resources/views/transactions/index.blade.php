<x-midone.app-layout>
    ...
    <div class="flex flex-wrap -mx-3 mt-5">
        <div class="w-full sm:w-1/2 xl:w-1/2 px-3 mb-6">
            <div class="report-box zoom-in">
                <div class="box p-5">
                    <div class="text-3xl font-medium leading-8 mt-6">{{ $count_order }}</div>
        ...
        <div class="w-full sm:w-1/2 xl:w-1/2 px-3 mb-6">
            <div class="report-box zoom-in">
                <div class="box p-5">
                    <div class="text-3xl font-medium leading-8 mt-6">{{ $count_product }}</div>
    ...
    <div class="intro-y box mt-5">
        <div class="p-5">
            <h1 class="text-2xl mt-5 mb-5" style="font-size: 2em; margin-top: 5px" class="mb-5">Data Transaksi dalam 3
                Bulan</h1>
...
<script>
    ...
    const labels3Bulan = {!! json_encode($month_chart->pluck('produk')) !!};
    const data3Bulan = {!! json_encode($month_chart->pluck('jumlah_produk')) !!};
    const backgroundColors3Bulan = generateRandomColors(data3Bulan.length);
    ...
    const labels1Tahun = {!! json_encode($year_chart->pluck('produk')) !!};
    const data1Tahun = {!! json_encode($year_chart->pluck('jumlah_produk')) !!};
    const backgroundColors1Tahun = generateRandomColors(data1Tahun.length);
